...
class ApiResponseDtoBusStopResponseDto {
  /// Returns a new [ApiResponseDtoBusStopResponseDto] instance.
  ...
  /// Returns a new [ApiResponseDtoBusStopResponseDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApiResponseDtoBusStopResponseDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ApiResponseDtoBusStopResponseDto(
        success: mapValueOfType<bool>(json, r'success')!,
        data: BusStopResponseDto.fromJson(json[r'data']),
  ...
  static List<ApiResponseDtoBusStopResponseDto> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApiResponseDtoBusStopResponseDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApiResponseDtoBusStopResponseDto> mapFromJson(
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = ApiResponseDtoBusStopResponseDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
