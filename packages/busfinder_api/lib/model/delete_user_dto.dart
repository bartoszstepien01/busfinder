...
class DeleteUserDto {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is DeleteUserDto && other.id == id;
  ...
  @override
  String toString() => 'DeleteUserDto[id=$id]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DeleteUserDto[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DeleteUserDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DeleteUserDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<DeleteUserDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DeleteUserDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
