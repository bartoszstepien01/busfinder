...
class ApiResponseDtoListScheduleResponseDto {
  /// Returns a new [ApiResponseDtoListScheduleResponseDto] instance.
  ...
  /// Returns a new [ApiResponseDtoListScheduleResponseDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApiResponseDtoListScheduleResponseDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ApiResponseDtoListScheduleResponseDto(
        success: mapValueOfType<bool>(json, r'success')!,
        data: ScheduleResponseDto.listFromJson(json[r'data']),
  ...
  static List<ApiResponseDtoListScheduleResponseDto> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApiResponseDtoListScheduleResponseDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
