...
class ApiResponseDtoLoginResponseDto {
  /// Returns a new [ApiResponseDtoLoginResponseDto] instance.
  ...
  /// Returns a new [ApiResponseDtoLoginResponseDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApiResponseDtoLoginResponseDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ApiResponseDtoLoginResponseDto(
        success: mapValueOfType<bool>(json, r'success')!,
        data: LoginResponseDto.fromJson(json[r'data']),
  ...
  static List<ApiResponseDtoLoginResponseDto> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApiResponseDtoLoginResponseDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApiResponseDtoLoginResponseDto> mapFromJson(dynamic json) {
    final map = <String, ApiResponseDtoLoginResponseDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ApiResponseDtoLoginResponseDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
