...
class DeleteScheduleDto {
  /// Returns a new [DeleteScheduleDto] instance.
  DeleteScheduleDto({
    required this.id,
  });
  ...
  /// Returns a new [DeleteScheduleDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DeleteScheduleDto? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<DeleteScheduleDto> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DeleteScheduleDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DeleteScheduleDto> mapFromJson(dynamic json) {
    final map = <String, DeleteScheduleDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DeleteScheduleDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
