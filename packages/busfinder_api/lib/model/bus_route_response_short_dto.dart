...
class BusRouteResponseShortDto {
  /// Returns a new [BusRouteResponseShortDto] instance.
  BusRouteResponseShortDto({
    required this.id,
    required this.name,
  });
  ...
  /// Returns a new [BusRouteResponseShortDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static BusRouteResponseShortDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return BusRouteResponseShortDto(
  ...
  static List<BusRouteResponseShortDto> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = BusRouteResponseShortDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, BusRouteResponseShortDto> mapFromJson(dynamic json) {
    final map = <String, BusRouteResponseShortDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = BusRouteResponseShortDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
