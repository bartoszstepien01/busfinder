...
class ApiResponseDtoListUserResponseDto {
  /// Returns a new [ApiResponseDtoListUserResponseDto] instance.
  ...
  /// Returns a new [ApiResponseDtoListUserResponseDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApiResponseDtoListUserResponseDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ApiResponseDtoListUserResponseDto(
  ...
  static List<ApiResponseDtoListUserResponseDto> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApiResponseDtoListUserResponseDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApiResponseDtoListUserResponseDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = ApiResponseDtoListUserResponseDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
