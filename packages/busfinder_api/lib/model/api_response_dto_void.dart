...
class ApiResponseDtoVoid {
  /// Returns a new [ApiResponseDtoVoid] instance.
  ApiResponseDtoVoid({
  ...
  /// Returns a new [ApiResponseDtoVoid] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApiResponseDtoVoid? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ApiResponseDtoVoid> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApiResponseDtoVoid.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApiResponseDtoVoid> mapFromJson(dynamic json) {
    final map = <String, ApiResponseDtoVoid>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ApiResponseDtoVoid.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
